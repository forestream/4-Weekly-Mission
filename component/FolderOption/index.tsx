...
const FolderOption = ({ selectedFolder, setSelectedFolder }: Props) => {
	const [editModalOpen, setEditModalOpen] = useState(false);
	const [shareFolderModalOpen, setShareFolderModalOpen] = useState(false);
	const [deleteFolderModalOpen, setDeleteFolderModalOpen] = useState(false);

	const options: { [index: string]: Function } = {
		share: setShareFolderModalOpen,
		editName: setEditModalOpen,
		delete: setDeleteFolderModalOpen
	};
